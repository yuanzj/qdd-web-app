    ...
    mounted () {
      ...
      if (this.$route.query) {
        ...
        if (this.$route.query.token) {
          this.axios.defaults.headers.common['Authorization'] = 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOjM2NzQsImF1ZGllbmNlIjoid2ViIiwiY3JlYXRlZCI6MTUyMzkzMDc4NDQzNSwicm9sZXMiOiJBRE1JTiIsImV4cCI6MTUyNDUzNTU4NH0.V0BIXpXjUeBorxgaL3xe29Er3nkfWH8dpXMYPI01yKkmkZhNyaib9qfFTPH-4zX5JS4S33RDsXjEfXp4X7Efyw'
        }
      }
